...
export function Statistics() {
    ...
    return (
        <div className="flex flex-col gap-6">
            ...
            <div className="grid h-64 grid-cols-4 gap-6">
                {/* current habits */}
                <div className="col-span-3 flex h-64 w-full flex-col gap-3 rounded-md bg-neutral-900 p-3">
                    <h2 className="text-lg font-bold">Hábitos atuais</h2>
                    <div className="bg-neutral-800 w-full h-full rounded-md px-6">
                        <ResponsiveCalendar
                            data={calendarData}
                            from="2024-01-02"
                            to="2024-12-31"
